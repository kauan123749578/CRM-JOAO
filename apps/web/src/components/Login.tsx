      ...
      <div className="relative w-full max-w-md z-10">
        <div className="bg-zinc-900/90 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-10">
            {/* Logo JOÃO FORNECEDOR */}
            <div className="relative mx-auto mb-8">
              <div className="absolute inset-0 bg-yellow-500/20 rounded-full blur-2xl animate-pulse"></div>
              <div className="relative w-28 h-28 mx-auto bg-zinc-950 rounded-3xl flex items-center justify-center shadow-[0_0_50px_-12px_rgba(234,179,8,0.3)] border border-zinc-800 transform hover:scale-105 transition-all duration-500 group overflow-hidden p-3">
                <img 
                  src={logoJoaoFornecedor} 
                  alt="JOÃO FORNECEDOR" 
                  className="w-full h-full object-contain drop-shadow-[0_0_10px_rgba(234,179,8,0.6)]"
                />
              </div>
            </div>
